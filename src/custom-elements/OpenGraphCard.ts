...
export class OpenGraphCard extends NonShadowedElement {
    ...
    public render(): TemplateResult {
        return html`
            <a
                class="rounded-xl overflow-hidden border border-zinc-300 dark:border-zinc-600 leading-snug block text-left font-sans w-full text-sm bg-zinc-50 dark:bg-zinc-900 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition ease-out duration-100"
                href=${this.href}
                target="_blank"
                title=${this.title}
